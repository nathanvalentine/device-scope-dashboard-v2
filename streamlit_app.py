...
def count_all_5_contexts(df: pd.DataFrame) -> int:
    ...
    # Ensure boolean columns (Copilot eliminated this with normalization helper functions above)
...
# (Copilot eliminated this with normalization helper functions above)
#filtered_df["Duplicate Devices"] = normalize_bool_column(filtered_df["Duplicate Devices"])
